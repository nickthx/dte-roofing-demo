            ...
            {faqSections.map((section, sectionIndex) => (
              <div key={sectionIndex} className="mb-16">
                ...
                <div className="flex items-center mb-8">
                  ...
                  <h2 className="text-3xl font-bold text-charcoal-900">Roof Lifespan & Inspection Guidance · Service Offerings · Installation Timeline & Free Estimates · Financing & Insurance · Warranty & Contact Information</h2>
                </div>
