...
import { Phone, Shield, Clock, Award, CheckCircle, Star, ChevronRight, BadgeCheck, Search, FileText, Wrench, CheckCircle2, MapPin, ExternalLink } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <>
      ...
      <SEO
        title={`DTE Roofing – Columbus Roofing Experts | Founded 2023 | ${reviewData?.totalReviews || 86} Five-Star Reviews`}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-white drop-shadow-lg">
              Columbus's Roofing Experts — Honest Work. Superior Results.
            </h1>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal-900 mb-4">Our Services</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
            {[
              ...
              },
              {
                ...
                description: 'Seamless gutters & guards that protect roof edge and foundation.',
                proof: 'Leak-free miters',
